        ...
        <div class="min-h-screen bg-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <x-nav-link :href="route('admin.addrooms')" :active="request()->routeIs('admin.addrooms')">
                                    {{ __('Tambah Ruangan') }}
                                </x-nav-link>
                            </div>
            ...
            <header class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <p class="text-2xl font-bold text-gray-700">Add Rooms</p>
                </div>
            </header>

            <!-- Page Content -->
            <main class="py-20 px-28">
                ...
                <form class="max-w-md mx-auto py-4" action="{{ route('admin.addrooms') }}" method="POST">
                    @csrf
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <label for="name" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama Ruangan</label>
                    </div>
                    <div class="relative z-0 w-full mb-5 group">
                    ...
                    <textarea id="description" name="description" rows="4" class=" mb-5 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Deskripsi"></textarea>
