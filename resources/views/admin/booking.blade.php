        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main>
                <div class="max-w-md mx-auto py-5">
                    <form action="{{ route('admin.search') }}" method="GET" class="mb-5">
            ...
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-5">
                ...
                <div class="flex justify-between items-center mt-4">
                    ...
                    <a href="{{ route('admin.singleRoom', $room->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-gray-400 rounded-lg hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                       Selengkapnya
